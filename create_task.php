...
<html>
<head>
	<title>Create Task | Task Pro</title>
            ...
            <div class="form-container">
                ...
                <form method="POST" action="app/add-task.php">
                    ...
                    <div class="input-holder">
                        ...
                        <input type="text" name="title" class="modern-input" placeholder="e.g., Weekly Strategic Review" required>
                    </div>

                    <div class="input-holder">
                        <label class="label-text">Description</label>
                        <textarea name="description" class="modern-input" style="height: 120px; resize: none;" placeholder="Provide detailed instructions for the task..." required></textarea>
                    </div>
